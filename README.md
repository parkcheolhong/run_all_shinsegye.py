...
- 🎤 **[음성 문제 해결 가이드](VOICE_TROUBLESHOOTING_GUIDE.md)** - 음성 인식 문제 완벽 해결 (신규!)
...
음성 인식이 작동하지 않나요? **[음성 문제 해결 가이드](VOICE_TROUBLESHOOTING_GUIDE.md)**에서 상세한 해결 방법을 확인하세요!
