...
# AI 시스템 모듈들 import (새로 추가된 5개 시스템)
try:
    from modules.ai_code_manager.ai_music_composer import AIMusicComposer
    from modules.ai_code_manager.dream_interpreter import DreamInterpreter
    from modules.ai_code_manager.virtual_dev_team import VirtualDevTeam
    from modules.ai_code_manager.future_prediction_engine import FuturePredictionEngine
    from modules.ai_code_manager.emotion_color_therapist import EmotionColorTherapist
except ImportError as e:
    print(f"AI 시스템 모듈 import 오류: {e}")
