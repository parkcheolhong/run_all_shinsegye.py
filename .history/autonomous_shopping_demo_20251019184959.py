...
def test_autonomous_shopping_mall():
    ...
    # 3. 자동 판매 시스템
    print("\n💰 3. AI 자동 판매 시스템...")
    sales_result = mall.ai_auto_selling()
    print("✅ 자동 판매 진행 중!")
...
def test_autonomous_marketing_system():
    ...
    # 3. 고객 피드백 분석
    print("\n💬 3. 고객 피드백 자동 분석...")
    feedback_analysis = marketing_system.ai_customer_feedback_analysis()
    print("✅ 피드백 분석 완료!")
...
def main():
    ...
    try:
        ...
        # 3. 자율 마케팅 시스템 테스트
        marketing_result = test_autonomous_marketing_system()
